var EBW = (function (exports, tslib_1, TSFoundation) {
	...
	*/
	...
	var DiffPrintButton = /** @class */ (function () {
	    function DiffPrintButton(button, container) {
	        this.button = button;
	        this.container = container;
	        button.addEventListener('click', function (evt) {
	            evt.preventDefault();
	    ...
	    return DiffPrintButton;
	}());
	//# sourceMappingURL=DiffPrintButton.js.map
	...
	var RepoDiffPatchPage = /** @class */ (function () {
	    function RepoDiffPatchPage(context) {
	        ...
	        new DiffPrintButton(document.getElementById('diff-print-button'), document.getElementById('repo-diff-patch'));
	    }
